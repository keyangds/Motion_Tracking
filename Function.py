...
def likelihood_test(data):
        ...
        print(count1/len(data['likelihood_HindLeftPaw']))
        print(count2/len(data['likelihood_HindLeftPaw']))
        
        print(sum1)
        print(sum2)
        
        
        if (count1/len(data['likelihood_HindLeftPaw'])) > 0.25 and (count2/len(data['likelihood_HindLeftPaw'])) > 0.25:
